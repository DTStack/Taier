...
const RelationTableSelect = (props: IPropsRelationTableSelect) => {
	...
	useEffect(() => {
		isPartition(modelDetail.dsId, currentFormValue.schema, currentFormValue.tableName);
	}, [currentFormValue.tableName]);

	return (
		<div className="padding-top-20" ref={cref}>
			<Form className="dm-form" labelCol={{ span: 3 }} wrapperCol={{ span: 21 }}>
						...
						{getFieldDecorator('updateType', {
							...
							>
								{updateTypeList.map((updateType) => (
									<Option key={updateType.leftValue} value={updateType.leftValue}>
