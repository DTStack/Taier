import { ANALYTICS_ENGINE_BASE_URL } from '../consts/reqUrls';
...
export default {
  ...
  // GET_DB_USER_ROLE_LIST: `${ANALYTICS_ENGINE_BASE_URL}/roleUser/pageQuery`, // 获取用户角色列表
  ...
  ANALYENGINE_GET_DBLIST: `${ANALYTICS_ENGINE_BASE_URL}/dataBaseManagement/listAllDatabases`, // 获取数据库列表

  ANALYENGINE_QUERY_USER: `${ANALYTICS_ENGINE_BASE_URL}/user/pageQuery`, // 查询系统用户信息
  ANALYENGINE_REMOVE_USER: `${ANALYTICS_ENGINE_BASE_URL}/roleUser/removeRoleUserFromProject`, // 删除用户
  ...
  ANALYENGINE_SEARCH_UIC_USERS: `${ANALYTICS_ENGINE_BASE_URL}/user/getUicUsersNotInProject`, // 获取UIC用户列表 获取未添加到项目的用户
  // 角色
