...
class TenantModal extends React.Component<any, any> {
    ...
    checkTenant = (data: any) => {
        ...
        const isHavaCurTenant = data.findIndex((v: any) => v.tenantId === parseInt(curTenantId));
    ...
    render () {
        ...
        return (
            <Modal
                ...
                footer={
                    [
                        <Button key="back" className="c-tenantModal__modal__btn" onClick={closeTenantModal}>取消</Button>,
                        <Button
                            key="submit"
                            type="primary"
