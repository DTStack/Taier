...
export default {
  ...
  updateRole(app: any, params?: any) {
    switch (app) {
      ...
      case MY_APPS.ANALYTICS_ENGINE:
        return http.post(
          analyEngineUrls.ANALYENGINE_ROLE_PERMISSION_ADD_OR_EDIT,
          params
        );
      case MY_APPS.DATA_QUALITY:
  ...
  markAsRead(app: any, params?: any) {
    switch (app) {
      ...
      case MY_APPS.ANALYTICS_ENGINE:
        return http.post(
          analyEngineUrls.ANALYENGINE_MASSAGE_MARK_AS_READ,
          params
        );
      case MY_APPS.DATA_QUALITY:
  ...
  markAsAllRead(app: any, params?: any) {
    switch (app) {
      ...
      case MY_APPS.ANALYTICS_ENGINE:
        return http.post(
          analyEngineUrls.ANALYENGINE_MASSAGE_MARK_AS_ALL_READ,
          params
        );
      case MY_APPS.DATA_QUALITY:
