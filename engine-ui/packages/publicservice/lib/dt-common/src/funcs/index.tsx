...
import { rdosApp, streamApp, scienceApp, tagApp, daApp, dqApp } from '../consts/defaultApps';
            ...
            config = {
                ...
                message: <span>
                    ...
                    {notifyMsgs.length ? null : (
                        ...
                        }} className='dt-notification-close-btn'>全部关闭</a>
                    )}
                </span>
            }
...
export function isCookieBeProjectType (key: any) {
    return ['project_id', 'science_project_id', 'tag_project_id', 'stream_project_id', 'api_project_id', 'dq_project_id'].includes(key);
}
...
export function compareEnableApp (apps: any, licenseApps: any, isShowHome?: any) {
    let validateAppIds = [MY_APPS.RDOS, MY_APPS.STREAM, MY_APPS.DATA_QUALITY,
        MY_APPS.API, MY_APPS.ANALYTICS_ENGINE, MY_APPS.SCIENCE, MY_APPS.TAG, MY_APPS.DATA_ASSETS]; // license控制的appID
