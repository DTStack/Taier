...
window.APP_CONF = {
    prefix: '', // 应用前缀
    name: 'Console', // 应用名字
    loadingTitle: 'Console · 控制台', // loading的应用名字
    logo: 'public/img/logo.svg', // header图标
    titleName: 'Console · 控制台', // 网页titletheme: 'default', // 主题
    hideUserCenter: false, // 隐藏用户中心按钮
    disableHelp: false, // 禁用帮助文档
    UIC_URL: 'http://dtuic.dtstack.cn', // UIC中心地址
    UIC_DOMAIN: '.dtstack.cn', // UIC域名
    closeBrowserCheck: false, // 是否关闭浏览器检查，默认为 false
    EASY_INDEX_URL: 'http://dev.insight.dtstack.cn/easyIndex', // 指标产品地址
