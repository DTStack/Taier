...
export const ENGINE_TYPE_ARRAY = [
	{
		// 引擎类型下拉框数据
		name: 'Hadoop',
...
export const DEFAULT_COMP_TEST: any = {
	// 测试结果默认数据
	flinkTestResult: {},
	sparkTestResult: {},
...
export const DEFAULT_COMP_REQUIRED: any = {
	// 必填默认数据
...
export const HADOOP_GROUP_VALUE = [
	// hadoop 引擎支持的组件类型(复选框)
...
// 检验各组件数据
export const validateFlinkParams: any = [
	// flink
...
export const validateHiveParams: any = [
	// hive <=> Spark Thrift Server
	'hiveConf.jdbcUrl',
	'hiveConf.driverClassName',
	'hiveConf.kerberosFile',
];
export const validateCarbonDataParams: any = [
	// carbonData
	'carbonConf.jdbcUrl',
	'carbonConf.kerberosFile',
];
export const validateImpalaSqlParams: any = [
	// impalaSql
	'impalaSqlConf.jdbcUrl',
];
export const validateHiveServerParams: any = [
	// carbonData
	'hiveServerConf.jdbcUrl',
	'hiveServerConf.kerberosFile',
];
export const validateSparkParams: any = [
	// spark
	'sparkConf.typeName',
...
export const validateLibraParams: any = ['libraConf.jdbcUrl', 'libraConf.driverClassName'];
export const validateSftpDataParams: any = [
	// carbonData
	'sftpConf.host',
	'sftpConf.port',
	'sftpConf.path',
...
export const FLINK_KEY_MAP: any = {
	...
	'metrics.reporter.promgateway.randomJobNameSuffix':
		'metricsReporterPromgatewayRandomJobNameSuffix',
...
export const notExtKeysFlink: any = [
	...
	'yarn.taskmanager.heap.mb',
	'yarn.taskmanager.numberOfTaskSlots',
	'yarn.taskmanager.numberOfTaskManager',
	'openKerberos',
	'kerberosFile',
...
export const notExtKeysLearning: any = [
	'typeName',
	'learning.python3.path',
	'learning.python2.path',
	'learning.history.address',
	'learning.history.webapp.address',
...
export const notExtKeyDtscriptPython: any = ['typeName', 'python2.path', 'python3.path'];
...
export const formItemCenterLayout: any = {
	// center
	labelCol: {
		xs: { span: 24 },
		sm: { span: 9 },
...
export const specFormItemLayout: any = {
	// 表单对称布局
	labelCol: {
		xs: { span: 24 },
		sm: { span: 8 },
...
export const tailFormItemLayout: any = {
	// 表单行label居中对齐
	wrapperCol: {
		xs: {
			span: 24,
...
export const doubleLineAreaChartOptions: any = {
	// 堆叠折现图默认选项
...
export const EMAIL_COMMA = /^[0-9a-zA-Z@,_.-]+$/;

export const EMAIL_REG = /^[0-9a-zA-Z_.-]+[@][0-9a-zA-Z_.-]+([.][a-zA-Z]+){1,2}$/;
