...
export const COMPONEMT_CONFIG_NAME_ENUM = {
    ...
    [COMPONENT_TYPE_VALUE.SPARKTHRIFTSERVER]: COMPONENT_CONFIG_NAME.SPARKTHRIFTSERVER,
    [COMPONENT_TYPE_VALUE.CARBONDATA]: COMPONENT_CONFIG_NAME.CARBONDATA,
    [COMPONENT_TYPE_VALUE.HIVESERVER]: COMPONENT_CONFIG_NAME.HIVESERVER,
    [COMPONENT_TYPE_VALUE.LIBRASQL]: COMPONENT_CONFIG_NAME.LIBRASQL,
    [COMPONENT_TYPE_VALUE.TIDB_SQL]: COMPONENT_CONFIG_NAME.TIDB_SQL,
    [COMPONENT_TYPE_VALUE.SFTP]: COMPONENT_CONFIG_NAME.SFTP,
    [COMPONENT_TYPE_VALUE.TIDB_SQL]: COMPONENT_CONFIG_NAME.TIDB_SQL,
    [COMPONENT_TYPE_VALUE.IMPALASQL]: COMPONENT_CONFIG_NAME.IMPALASQL,
...
export const COMPUTE_COMPONENTS: any = [
    ...
    { componentTypeCode: COMPONENT_TYPE_VALUE.SPARKTHRIFTSERVER, componentName: COMPONENT_CONFIG_NAME.SPARKTHRIFTSERVER },
    { componentTypeCode: COMPONENT_TYPE_VALUE.FLINK, componentName: COMPONENT_CONFIG_NAME.FLINK },
    { componentTypeCode: COMPONENT_TYPE_VALUE.HIVESERVER, componentName: COMPONENT_CONFIG_NAME.HIVESERVER },
    { componentTypeCode: COMPONENT_TYPE_VALUE.IMPALASQL, componentName: COMPONENT_CONFIG_NAME.IMPALASQL },
    ...
    { componentTypeCode: COMPONENT_TYPE_VALUE.LIBRASQL, componentName: COMPONENT_CONFIG_NAME.LIBRASQL },
