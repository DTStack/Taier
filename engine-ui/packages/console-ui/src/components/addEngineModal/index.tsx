...
class AddEngineModal extends React.Component<any, any> {
    ...
    renderEngineComponents = () => {
        ...
        const checkedGreenPlum = engines.indexOf(ENGINE_TYPE_NAME.GREEN_PLUM) > -1;
        ...
        return (
            <React.Fragment>
                ...
                <FormItem
                    ...
                    {...formItemLayout}
                    style={{ marginBottom: '4px' }}
                    className={checkedGreenPlum ? 'c-formItem__checked' : ''}
                >
                    {getFieldDecorator('greenPlumrequiredEngines', {
                        rules: [{
                            required: checkedGreenPlum,
                            message: ''
                        }],
                        initialValue: COMPONENT_TYPE_VALUE.GREEN_PLUM_SQL
                    })(
                        <span>GreenPlum SQL</span>
                    )}
                </FormItem>
            </React.Fragment>
        );
