...
import { publishType, TASK_TYPE } from '../consts/comm';
...
export default {
    ...
    getLoginedUser (params: any) {
        return http.post(req.GET_USER_BY_ID, params)
    },
    ...
    getUserRoles (params: any) {
        return http.post(req.GET_USER_ROLES, params)
    },
    handoverOwner (params: any) {
        return http.post(req.HAND_OVER_OWNER, params)
    },
    ...
    checkUserHaveOwner (params: any) {
        return http.post(req.GET_USER_IS_OWNER, params)
    },
    ...
    getProjectTaskUsers (params: any) {
        return http.post(offlineReq.GET_PROJECTTASK_USER, params)
    },
    ...
    selectAlarm (params: any) {
        return http.post(offlineReq.SELECT_ALARM, params)
    },
    ...
    listPrincipalWithKeytab (params: any) {
        return http.postAsFormData(offlineReq.LIST_PRINCIPAL_WITH_KEYTAB, params)
    },
    ...
    getRePublishList (params: any, type = 'offline', listType = publishType.TASK) {
        const urlMap: any = {
            offline: {
                ...
                [publishType.PRODUCER]: req.GET_OFFLINE_FUNCTION
            }
        }
    ...
    // 202105数据依赖分页
    getDataDependent (params: any) {
        return http.post(offlineReq.DEPENDENT_PAGING, params)
    },
    // 202105数据依赖检查模板名称
    getDataDependentCheckName (params: any) {
        return http.post(offlineReq.DEPENDENT_PAGING_CHECKNAME, params)
    },
    // 202105数据依赖删除
    getDataDependentDelete (params: any) {
        return http.post(offlineReq.DEPENDENT_PAGING_DELETE, params)
    },
    // 202105数据依赖详情
    getDataDependentDetail (params: any) {
        return http.post(offlineReq.DEPENDENT_PAGING_DETAIL, params)
    },
    // 202105数据依赖责任人下拉框
    getDataDependentLiable (params: any) {
        return http.post(offlineReq.DEPENDENT_PAGING_LIABLE, params)
    },
    // 202105数据依赖保存
    getDataDependentSave (params: any) {
        return http.post(offlineReq.DEPENDENT_PAGING_SAVE, params)
    },
    // 202105数据依赖sql测试
    getDataDependentSql (params: any) {
        return http.post(offlineReq.DEPENDENT_PAGING_TSQL, params)
    },
    // 202105数据依赖详情中下游的分页
    getDataDependentPage (params: any) {
        return http.post(offlineReq.DEPENDENT_PAGING_IDXPAGE, params)
    }
}
