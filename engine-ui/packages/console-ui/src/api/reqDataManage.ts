...
//  copyTableStructure: 添加参数tableType
    ...
    // ===== 数据文件治理 ===== //
    // 治理规则
    GET_FILEMANAGE_LIST: `${RDOS_BASE_URL}/batch/fileManage/ruleQuery`, // 获取数据治理列表
    ADD_OR_UPDATE_RULE: `${RDOS_BASE_URL}/batch/fileManage/addOrUpdateRule`, // 添加或更新规则
    DELETE_RULE: `${RDOS_BASE_URL}/batch/fileManage/deleteRule`, // 添加或更新规则
    DETAIL_RULE: `${RDOS_BASE_URL}/batch/fileManage/getRuleById`, // 获取规则详情

    // 治理历史
    GET_HISTORY_LIST: `${RDOS_BASE_URL}/batch/fileManage/recordQuery`, // 获取治理历史列表
    GET_HISTORY_DETAIL: `${RDOS_BASE_URL}/batch/fileManage/partitionQuery`, // 获取治理历史列表
    CANCEL_MERGE: `${RDOS_BASE_URL}/batch/fileManage/cancelMerge` // 中止规则合并
};
