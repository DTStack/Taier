import { RDOS_BASE_URL, RDOS_BASE_URL_X } from './req';
export default {
    ...
    GET_PROJECTTASK_USER: `${RDOS_BASE_URL}/common/project/getProjectTaskUsers`, // 修改任务责任人获取用户列表
    ...
    LIST_PRINCIPAL_WITH_KEYTAB: `${RDOS_BASE_URL}/upload/batch/batchDataSource/listPrincipalWithKeytab`, // 获取 principal 列表
    ...
    SELECT_ALARM: `${RDOS_BASE_URL}/batch/batchAlarm/selectAlarm`, // 根据项目id获取任务列表
    ...
    // 202105新数据依赖
    DEPENDENT_PAGING: `${RDOS_BASE_URL_X}/depend/page`, // 数据依赖分页
    DEPENDENT_PAGING_CHECKNAME: `${RDOS_BASE_URL_X}/depend/checkName`, // 数据依赖检查模板名称
    DEPENDENT_PAGING_DELETE: `${RDOS_BASE_URL_X}/depend/delete`, // 数据依赖删除
    DEPENDENT_PAGING_DETAIL: `${RDOS_BASE_URL_X}/depend/detail`, // 数据依赖详情
    DEPENDENT_PAGING_LIABLE: `${RDOS_BASE_URL_X}/depend/liable`, // 数据依赖责任人下拉框
    DEPENDENT_PAGING_SAVE: `${RDOS_BASE_URL_X}/depend/save`, // 数据依赖保存
    DEPENDENT_PAGING_TSQL: `${RDOS_BASE_URL_X}/depend/trySql`, // 数据依赖测试sql

    DEPENDENT_PAGING_IDXPAGE: `${RDOS_BASE_URL_X}/depend/idxPage` // 数据依赖详情中下游的分页
}
