...
// 运维中心新的地址
export const RDOS_BASE_URL_X = '/api/easyIndex/operate';
// 从config文件全局读取运维中心20210428
// export const OPERATION_CENTER = '/api/node';
...
export default {
    ...
    GET_USER_ROLES: `${RDOS_BASE_URL}/common/roleUser/getUsersAndPermission`, //  特定项目下的角色用户信息
    HAND_OVER_OWNER: `${RDOS_BASE_URL}/common/roleUser/handoverOwner`, //  转移责任人接口
    ...
    GET_USER_IS_OWNER: `${RDOS_BASE_URL}/common/roleUser/checkUserHaveOwner`, // 删除项目用户接口
