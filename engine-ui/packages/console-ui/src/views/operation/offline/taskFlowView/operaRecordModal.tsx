...
class OperaRecordModal extends React.Component<any, any> {
    state: any = {
        dataSource: [],
        queryParams: {
            taskId: undefined,
    ...
    getOperaRecordData = (param?: any) => {
        ...
        Api.operaRecordData(param).then((res: any) => {
            if (res.code === 1) {
                this.setState({
    ...
    handleTableChange = (pagination: any, filter: any) => {
        this.setState({
            queryParams: Object.assign({}, this.state.queryParams, {
