		...
		<div className="ant-table bd task-detail">
			<table>
				<tbody className="ant-table-tbody">
					<tr>
						<td>任务名称：</td>
						<td>{task.batchTask.name || '-'}</td>
						<td>任务ID：</td>
						<td>{task.batchTask.id || '-'}</td>
					</tr>
					<tr>
						<td>任务类型：</td>
						<td>
							<TaskType value={task.batchTask.taskType} />
						</td>
						<td>状态：</td>
						<td>
					...
					<tr>
						...
						<td>责任人：</td>
						<td>{get(task, 'batchTask.ownerUser.userName', '-')}</td>
					</tr>
				</tbody>
			</table>
		</div>
		...
		<div className="task-floating-window ant-table bd">
			<table>
				<tbody className="ant-table-tbody">
					<tr>
						<td>任务名称：</td>
						<td>{task.batchTask ? task.batchTask.name : '-'}</td>
					</tr>
					<tr>
						<td>运行状态：</td>
						<td>
