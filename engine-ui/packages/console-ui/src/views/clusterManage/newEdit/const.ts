...
export const CONFIG_BUTTON_TYPE = {
	...
	[TABS_TITLE_KEY.COMPUTE]: [
		...
		{
			code: COMPONENT_TYPE_VALUE.DTSCRIPT_AGENT,
			componentName: COMPONENT_CONFIG_NAME[COMPONENT_TYPE_VALUE.DTSCRIPT_AGENT],
		},
		{
			code: COMPONENT_TYPE_VALUE.INCEPTOR_SQL,
			componentName: COMPONENT_CONFIG_NAME[COMPONENT_TYPE_VALUE.INCEPTOR_SQL],
		},
		{
			code: COMPONENT_TYPE_VALUE.ANALYTIC_DB,
			componentName: COMPONENT_CONFIG_NAME[COMPONENT_TYPE_VALUE.ANALYTIC_DB],
		},
		{
			code: COMPONENT_TYPE_VALUE.MYSQL,
			componentName: COMPONENT_CONFIG_NAME[COMPONENT_TYPE_VALUE.MYSQL],
		},
		{
			code: COMPONENT_TYPE_VALUE.SQLSERVER,
			componentName: COMPONENT_CONFIG_NAME[COMPONENT_TYPE_VALUE.SQLSERVER],
		},
		{
			code: COMPONENT_TYPE_VALUE.DB2,
			componentName: COMPONENT_CONFIG_NAME[COMPONENT_TYPE_VALUE.DB2],
		},
		{
			code: COMPONENT_TYPE_VALUE.OCEANBASE,
			componentName: COMPONENT_CONFIG_NAME[COMPONENT_TYPE_VALUE.OCEANBASE],
		},
	],
};
