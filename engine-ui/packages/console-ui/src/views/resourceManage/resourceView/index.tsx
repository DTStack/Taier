...
import { pieOption, ALARM_DEFAULT, ALARM_HIGHT, SCHEDULE_TYPE } from './constant';
...
class Resource extends React.Component<any, any> {
	...
	render() {
		...
		const { usedCores, totalCores, usedMem, totalMem, memRate, coresRate } =
			this.state.resourceMetrics;
