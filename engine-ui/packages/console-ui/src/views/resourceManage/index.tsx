			...
			},
			{
				...
				render: (text: any, record: any) => {
					return (
						<a
							onClick={() => {
								this.clickSwitchNamespace(record);
							}}
						>
							切换Namespace
						</a>
		...
		return (
			<div className="resource-wrapper">
				...
				<div className="resource-content">
					<Card className="console-tabs resource-tab-width" bordered={false}>
						<Tabs
							tabPosition="left"
						...
						>
							{engineList &&
								engineList.map((item: any) => {
									...
									const engineName =
										isHadoop && isKubernetesEngine(resourceType)
											? 'Kubernetes'
											: ENGIN_TYPE_TEXT[engineType];
									return (
										<TabPane
				...
				<BindCommModal
					...
					isBindTenant={true}
					onCancel={() => {
						this.setState({ tenantModal: false });
					}}
