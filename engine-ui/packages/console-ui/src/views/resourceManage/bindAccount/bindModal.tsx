				...
				<React.Fragment>
					...
					<Form>
						{!isEdit ? (
									...
									>
										{userList &&
											userList.map((user: any) => {
												...
												return (
													<Option key={uid} title={uname} value={uid}>
														{uname}
													</Option>
												);
											})}
							...
							<React.Fragment>
								<Form.Item key="username" label="产品账号" {...formItemLayout}>
						...
						<Form.Item label="数据库账号" {...formItemLayout}>
						...
						<Form.Item label="数据库密码" {...formItemLayout}>
