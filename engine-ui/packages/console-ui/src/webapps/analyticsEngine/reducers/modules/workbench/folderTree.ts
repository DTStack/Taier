...
export const folderTreeRoot: any = {
    id: 0,
    name: 'treeRoot',
    level: 0,
    type: 'folder',
...
const replaceTreeNode = function (treeNode: any, replace: any) {
    if (
...
export default function folderTree (state = folderTreeRoot, action: any) {
