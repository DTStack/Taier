 ...
 */
export const switchTab = function (currentTab: any) {
    return {
 ...
 */
export const openTab = function (tabData: any) {
    return {
 ...
 */
export const closeTab = function (currentTab: any) {
    return {
 ...
 */
export const closeTabs = function (type: any) {
    if (type === 'OHTERS') {
        return {
 ...
 */
export const updateTab = function (tabData: any) {
    return {
 ...
 * 触发SQL查询
 */
export function onSQLQuery (params: any) {
    return (dispatch: any, getStore: any) => {
        ...
        const defaultSQLQueryTabData: any = {
            id: moment().valueOf(),
