 ...
 */
export function onRemoveDataMap (params: any) {
 ...
 * 获取DataMap详情
 */
export function onCreateDataMap (params: any) {
    ...
    return (dispatch: any, getStore: any) => {
        ...
        const defaultCreateDataMapData: any = {
            id: moment().valueOf(),
 ...
 * 获取DataMap详情
 */
export function onGetDataMap (params: any) {
    return async (dispatch: any) => {
