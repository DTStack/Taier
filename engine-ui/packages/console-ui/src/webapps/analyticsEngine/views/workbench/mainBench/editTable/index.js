      ...
      const tableColField = [
          {
              ...
              render: (text, record) => (
                  text !== 1 ? '-'
                      : <Checkbox disabled={!record.isNew} defaultChecked={text === 1} onChange={(e) => this.handleInvert(e, record)}></Checkbox>
              )
          }, {
              title: '字典编码',
              ...
              render: (text, record) => (
                  text !== 1 ? '-'
                      : <Checkbox disabled={!record.isNew} defaultChecked={text === 1} onChange={(e) => this.handleDictionary(e, record)}></Checkbox>
              )
          }, {
              title: '多维索引',
              ...
              render: (text, record) => (
                  text !== 1 ? '-'
                      : <Checkbox disabled={record.type === 'DOUBLE' || record.type === 'DECIMAL' || !record.isNew} defaultChecked={(record.type === 'DECIMAL' || record.type === 'DOUBLE') ? false : text === 1} onChange={(e) => this.handleSortColumn(e, record)}></Checkbox>
              )
          }, {
              title: '注释内容',
              dataIndex: 'comment',
