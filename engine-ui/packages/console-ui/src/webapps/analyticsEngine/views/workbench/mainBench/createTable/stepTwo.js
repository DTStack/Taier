...
const canotBeInvert = ['SMALLINT', 'INT', 'BIGINT', 'DOUBLE', 'DECIMAL'];
            ...
            },
            {
                ...
                render: (text, record) => (
                    <Select
                        ...
                        onChange={e => this.handleSelectChange(e, record)}
                    >
                        {fieldType.map(o => {
                            return (
            ...
            },
            {
                ...
                render: (text, record) => (
                    <Input
                        style={{ width: 159 }}
                        defaultValue={text}
                        onChange={e => this.handleCommentChange(e, record)}
                    />
                )
            },
            {
            ...
            },
            {
                ...
                render: (text, record) => (
                    <Checkbox
                        ...
                        onChange={e => this.handleInvert(e, record)}
                    />
                )
            },
            {
                ...
                render: (text, record) => (
                    <Checkbox
                        ...
                        onChange={e => this.handleDictionary(e, record)}
                    />
                )
            },
            {
                ...
                render: (text, record) => (
                    <Checkbox
                        ...
                        onChange={e => this.handleSortColumn(e, record)}
                    />
                )
            },
            {
