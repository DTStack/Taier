...
const dateType: any = ['beginDate', 'endDate']
function setFormDataValueAndMetadata (key: any, value: any, formData: any) {
    formData[key] = value;
