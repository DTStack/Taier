...
class NormalTaskForm extends React.Component<any, any> {
    ...
    getRootNode () {
        ...
        if (files && files.length) {
            ...
            const myFolder = children && children.find((node: any) => {
                ...
                <Form>
                    ...
                    >
                        {getFieldDecorator('refResourceIdList', {
                            ...
                            initialValue: tabData.refResourceList && tabData.refResourceList.length > 0 ? tabData.refResourceList.map((res: any) => res.id) : []
                        })(
                            <FolderTree loadData={this.loadData.bind(this, siderBarType.resource)} treeData={resourceFiles} isSelect={true} />
                        )}
                    </FormItem>
...
export default Form.create({
    onFieldsChange (props: any, values: any) {
        let { tabData } = props;
        let newFormData: any = { ...tabData };
