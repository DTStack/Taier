...
export const replacTreeNodeField = (treeNode, sourceField, targetField, arrField) => {
    if (treeNode) {
 ...
 * 替换 TreeNode
 */
export const replaceTreeNode = (treeNodeData, target) => {
    if (treeNodeData) {
...
/* eslint-disable */
class JobGraphView extends Component {
        ...
        return (
            ...
            >
                ...
                >
                    ...
                    <a title="双击任务可快速查看日志" onClick={() => { showJobLog(get(data, 'batchEngineJob.jobId' )) }} style={{ marginRight: '8' }}>查看日志</a>
