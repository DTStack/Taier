...
class killJobForm extends Component {
    state = {
        indeterminate: false,
        checkAll: false,
        submitLoading: false
    ...
    handleSelectAll = (e) => {
        ...
        this.props.form.setFieldsValue({
            'schedulingCycle': checked ? this.getSchedulingOptions().map(o => o.value) : []
        })
        this.setState({
            indeterminate: false,
            checkAll: checked
    ...
    // 调度周期
    handleSechedulingChange = (checkedList) => {
...
export default Form.create()(killJobForm);
