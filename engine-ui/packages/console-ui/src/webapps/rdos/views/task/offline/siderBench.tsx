...
class SiderBench extends React.Component<any, any> {
    state: any = {
        selected: '',
        expanded: false
    }
    ...
    handleTaskParamChange (newVal: any) {
    ...
    render () {
        return <div className="m-siderbench padding-r0" ref={(e: any) => { this.SideBench = e }}>
            <Tabs
