...
class BindProjectModal extends React.Component<any, any> {
    ...
    bindProject () {
        ...
        form.validateFields((err: any, values: any) => {
            if (!err) {
                const selectProject = projectBindList.filter((project: any) => {
...
export default Form.create<any>()(BindProjectModal);
