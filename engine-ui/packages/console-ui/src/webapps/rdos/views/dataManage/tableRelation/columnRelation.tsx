...
export default class TableRelation extends React.Component<any, any> {
    ...
    loadTableColumn = (params: any) => {
        const ctx = this;
        Api.getRelTableColumns(params).then((res: any) => {
            if (res.code === 1) {
    ...
    loadRelationColumns = (params: any) => {
        const ctx = this;
        ctx.showLoading()
        Api.getRelTableUpDownColumns(params).then((res: any) => {
            if (res.code === 1) {
    ...
    insertTableColumnVertext = (parent: any, data: any) => {
        const graph = this.graph;
        const tableData = this.getXmlNode(data);
        const rootCell = graph.getDefaultParent();
        ...
        return (
            <div className="graph-editor col-relation" style={{ position: 'relative', overflow: 'auto' }}>
                ...
                >
                    ...
                    <div
                        className="editor pointer" ref={(e: any) => { this.Container = e }}
                    />
                </Spin>
