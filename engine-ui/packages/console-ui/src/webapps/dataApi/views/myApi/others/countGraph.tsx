...
class MyApiCountGraph extends React.Component<any, any> {
    state: any = {
        apiId: '',
        data: {},
        graphType: GRAPH_TYPE.COUNT
    }
    getInfo (apiId: any, dateType: any) {
        if (!apiId) {
            return;
        }
    ...
    initLineChart () {
        ...
        let callCountDate: any = [];
        let failCountDate: any = [];
        let times: any = [];
...
export default MyApiCountGraph;
