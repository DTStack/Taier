            ...
            <div>
                <div className="steps-content">
                    <Card
                        ...
                        noHovering
                    >
                        <InputParams inputParamsChange={this.inputParamsChange.bind(this)} changeAddinputOverSignal={this.changeAddinputOverSignal.bind(this)} addInputsignal={this.state.addInputsignal} {...this.props} ></InputParams>
                    </Card>
                    <Card
                        title={
                            (() => {
                        ...
                        noHovering
                    >
                         <OutputParams inputToOutputData={this.state.inputToOutputData} outputParamsChange={this.outputParamsChange.bind(this)} changeAddoutputOverSignal={this.changeAddoutputOverSignal.bind(this)} addOutputsignal={this.state.addOutputsignal} {...this.props} ></OutputParams>
                ...
                >
                    ...
                    {
                        <Button type="primary" style={{ marginLeft: 8 }} onClick={() => this.pass()}>新建</Button>
                    }
