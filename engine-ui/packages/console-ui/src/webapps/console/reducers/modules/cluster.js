...
export const updateRequiredStatus = (data) => {
    return {
...
// reducer
export function testStatus (state = DEFAULT_COMP_TEST, action) {
    switch (action.type) {
...
export function showRequireStatus (state = DEFAULT_COMP_REQUIRED, action) {
    switch (action.type) {
