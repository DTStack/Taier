    ...
    render () {
        ...
        return (
            <Row className="area-input-Row" type='flex' gutter={8}>
                ...
                <Col>
                    <InputNumber disabled min={1} value={data ? data.lValue : null} onChange={this.onChangeLvalue}/>
                </Col>
                <Col>
                    {
                        centerText
                ...
                <Col>
                    <InputNumber disabled min={1} value={data ? data.rValue : null} onChange={this.onChangeRvalue}/>
                </Col>
                <Col>
                    {
                        rightText
