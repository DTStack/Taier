...
// app files
const MAIN_APP_FILE = path.resolve(MAIN_APP_PATH, 'app'); //根目录文件app地址
const RDOS_APP_FILE = path.resolve(RDOS_PATH, 'app'); //根目录文件app地址
const DATA_QUALITY_APP_FILE = path.resolve(DATA_QUALITY_PATH, 'app'); //根目录文件app地址
const DATA_API_APP_FILE = path.resolve(DATA_API_PATH, 'app'); //根目录文件app地址
const DATA_MAP_APP_FILE = path.resolve(DATA_MAP_PATH, 'app'); //根目录文件app地址
const META_DATA_APP_FILE = path.resolve(META_DATA_PATH, 'app'); //根目录文件app地址
const CORE_DATA_APP_FILE = path.resolve(CORE_DATA_PATH, 'app'); //根目录文件app地址
