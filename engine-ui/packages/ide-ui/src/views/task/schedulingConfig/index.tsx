...
import { EDIT_TASK_PREFIX, EDIT_FOLDER_PREFIX, CREATE_TASK_PREFIX } from '../../common/utils/const';
...
export class SchedulingConfig extends React.Component<any, any> {
	...
	render() {
		...
		const { current, isWorkflowNode, isIncrementMode, isScienceTask } = this.props;
		if (
			!current ||
			!current.activeTab ||
			...
			<molecule.component.Scrollable>
				<div className="m-scheduling" style={{ position: 'relative' }}>
					<Collapse bordered={false} defaultActiveKey={['1', '2', '3']}>
						...
						{!isWorkflowNode && tabData.taskType !== TASK_TYPE.VIRTUAL_NODE && (
								...
								<Row style={{ marginBottom: '16px' }}>
									...
									<Col>
										<RadioGroup
											...
											onChange={this.setSelfReliance.bind(this)}
											value={selfReliance}
										>
											{!isIncrementMode && (
