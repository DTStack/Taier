...
class ScheduleForm extends React.Component<any, any> {
  ...
  render() {
    ...
    const isHourOrMinTask =
      scheduleConf &&
      (scheduleConf.periodType === "0" || scheduleConf.periodType === "1");
    // 当工作流节点的调度周期为小时-1， 分-0时禁用调用时间选项
    const disabledInvokeTime =
      wFScheduleConf &&
      (wFScheduleConf.periodType === "0" || wFScheduleConf.periodType === "1");
        ...
        {!isWorkflowNode && (
          <div>
            <FormItem {...formItemLayout} label="生效日期">
              ...
              <span className="split-text" style={{ float: "none" }}>
                -
              </span>
            ...
            <FormItem {...formItemLayout} label="调度周期">
              <Col span={6}>
                {getFieldDecorator("periodType", {
                  ...
                  <Select
                    disabled={isScienceTask}
                    onChange={this.changeScheduleType.bind(this)}
                  >
        ...
        {(function (type: any, ctx: any) {
          ...
          switch (type) {
            ...
            case 2: {
              ...
              dom = (
                <span key={type}>
                  <FormItem {...formItemLayout} label={`${prefix}时间`}>
                    <Col span={6}>
        ...
        {isHourOrMinTask && ( // 仅小时或者
          <FormItem {...formItemLayout} label="延迟实例">
            {getFieldDecorator("isExpire", {
              ...
              <Checkbox onChange={this.changeScheduleConf.bind(this)}>
                自动取消
              </Checkbox>
            )}
        ...
        {scheduleConf.isExpire && (
          <FormItem {...formItemLayout} label="当天最后一个实例">
            {getFieldDecorator("isLastInstance", {
              ...
              <Group onChange={this.changeScheduleConf.bind(this)}>
