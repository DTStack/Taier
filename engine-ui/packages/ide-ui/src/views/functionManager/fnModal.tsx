...
class FnForm extends React.Component<any, any> {
    ...
    render() {
        ...
        sqlHead = `create or replace function ${schemaName}.${
            formData?.name || sqlName
        }`;
                        ...
                        <>
                            ...
                            <FormItem {...formItemLayout} label="资源">
                                ...
                                <FolderPicker
                                    ...
                                    onChange={this.handleResSelectTreeChange.bind(
                                        this
                                    )}
                                />
                            </FormItem>
                            ...
                            <FormItem {...formItemLayout} label="选择存储位置">
                                ...
                                <FolderPicker
                                    showFile={false}
                                    dataType="function"
                                    onChange={this.handleSelectTreeChange.bind(
                                        this
                                    )}
                                    defaultValue={
                                        formData
