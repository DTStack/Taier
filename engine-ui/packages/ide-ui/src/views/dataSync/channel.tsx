...
import { Form, InputNumber, Input, Select, Button, AutoComplete, Checkbox, Spin } from 'antd';

import { settingAction, workbenchAction } from '../../controller/dataSync/actionType';
...
class ChannelForm extends React.Component<any, any> {
	...
	renderBreakpointContinualTransfer = () => {
		...
		return isRDB(sourceType) &&
			...
			<div>
				{!isStandeAlone && (
					<FormItem {...formItemLayout} label="断点续传" className="txt-left">
			...
			<div className="g-step4">
				<Spin spinning={loading}>
					<Form>
						...
						<FormItem {...formItemLayout} label="作业并发数" style={{ height: '32px' }}>
						...
						{!isStandeAlone && (
							<>
								...
								<FormItem {...formItemLayout} label="错误记录数超过">
								...
								<FormItem {...formItemLayout} label="错误记录比例配置">
									<span style={{ float: 'left' }}>
										任务执行结束后，统计错误记录占比，大于
									</span>
