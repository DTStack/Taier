			...
			<div className="g-step5">
				<div className="m-preview" style={{ padding: '0px 20px' }}>
					<Card
						...
						title="选择来源"
						extra={
							<a href="javascript:void(0)" onClick={() => this.navtoStep(0)}>
								修改
							</a>
						}
					>
					...
					<Card
						...
						title="选择目标"
						extra={
							<a href="javascript:void(0)" onClick={() => this.navtoStep(1)}>
								修改
							</a>
						}
					>
					...
					<Card
						...
						title="字段映射"
						extra={
							<a href="javascript:void(0)" onClick={() => this.navtoStep(2)}>
								修改
							</a>
						}
					>
					...
					<Card
						...
						title="通道控制"
						extra={
							<a href="javascript:void(0)" onClick={() => this.navtoStep(3)}>
								修改
							</a>
						}
					>
