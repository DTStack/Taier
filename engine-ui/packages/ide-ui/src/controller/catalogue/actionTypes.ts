...
export const functionTreeAction = mc(['RESET_FUNCTION_TREE', 'LOAD_FOLDER_CONTENT'], {
...
export const greenPlumTreeAction = mc(['GET_SPARK_ROOT', 'LOAD_FOLDER_CONTENT'], {
...
export const libraSysFnTreeActon = mc(['RESET_SYSFUC_TREE', 'LOAD_FOLDER_CONTENT'], {
...
export const tiDBSysFnTreeActon = mc(['RESET_SYSFUC_TREE', 'LOAD_FOLDER_CONTENT'], {
	prefix: 'catalogue/tiDBSysTree/',
});

export const oracleFnTreeAction = mc(['GET_ORACLE_ROOT', 'LOAD_FOLDER_CONTENT'], {
	prefix: 'catalogue/oracleTree/',
});

export const oracleSysFnTreeActon = mc(['RESET_SYSFUC_TREE', 'LOAD_FOLDER_CONTENT'], {
	prefix: 'catalogue/oracleSysTree/',
});

export const greenPlumFnTreeAction = mc(['GET_GREEN_PLUM_ROOT', 'LOAD_FOLDER_CONTENT'], {
	prefix: 'catalogue/greenPlumTree/',
});

export const greenPlumSysFnTreeActon = mc(['RESET_SYSFUC_TREE', 'LOAD_FOLDER_CONTENT'], {
...
export const sparkSysFnTreeActon = mc(
	['RESET_SYSFUC_TREE', 'LOAD_FOLDER_CONTENT', 'ADD_FOLDER_CHILD', 'DEL_OFFLINE_FOLDER'],
