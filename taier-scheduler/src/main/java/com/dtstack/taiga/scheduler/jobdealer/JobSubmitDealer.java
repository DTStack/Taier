...
import com.dtstack.taiga.common.BlockCallerPolicy;
import com.dtstack.taiga.common.enums.EJobCacheStage;
import com.dtstack.taiga.common.env.EnvironmentContext;
import com.dtstack.taiga.common.exception.ClientAccessException;
import com.dtstack.taiga.common.exception.RdosDefineException;
import com.dtstack.taiga.common.exception.WorkerAccessException;
import com.dtstack.taiga.common.queue.DelayBlockingQueue;
import com.dtstack.taiga.common.util.SleepUtil;
...
import com.dtstack.taiga.pluginapi.exception.ClientArgumentException;
...
import com.dtstack.taiga.scheduler.jobdealer.bo.SimpleJobDelay;
import com.dtstack.taiga.scheduler.jobdealer.cache.ShardCache;
import com.dtstack.taiga.scheduler.server.JobPartitioner;
import com.dtstack.taiga.scheduler.server.queue.GroupInfo;
...
public class JobSubmitDealer implements Runnable {
    ...
    private boolean checkIsFinished(JobClient jobClient) {
        EngineJobCache engineJobCache = engineJobCacheService.getByJobId(jobClient.getJobId());
        try {
