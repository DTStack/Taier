...
import com.dtstack.taier.scheduler.server.pipeline.operator.Base64OperatorPipeline;
import com.dtstack.taier.scheduler.server.pipeline.operator.JobParamOperatorPipeline;
import com.dtstack.taier.scheduler.server.pipeline.operator.MergeOperatorPipeline;
import com.dtstack.taier.scheduler.server.pipeline.operator.ReplaceOperatorPipeline;
import com.dtstack.taier.scheduler.server.pipeline.operator.URLEncoderOperatorPipeline;
import com.dtstack.taier.scheduler.server.pipeline.params.FileParamPipeline;
import com.dtstack.taier.scheduler.server.pipeline.params.JobIdParamPipeline;
