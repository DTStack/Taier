...
import net.qihoo.xlearning.AM.ApplicationContainerListener;
import net.qihoo.xlearning.AM.ApplicationMessageService;
import net.qihoo.xlearning.AM.ApplicationWebService;
import net.qihoo.xlearning.AM.NMCallbackHandler;
import net.qihoo.xlearning.AM.RMCallbackHandler;
...
public class ApplicationMaster extends CompositeService {
  ...
  private static final Log LOG = LogFactory.getLog(net.qihoo.xlearning.AM.ApplicationMaster.class);
  ...
  private ApplicationMaster() {
    super(net.qihoo.xlearning.AM.ApplicationMaster.class.getName());
  ...
  public static void main(String[] args) {
    net.qihoo.xlearning.AM.ApplicationMaster appMaster;
    try {
      appMaster = new net.qihoo.xlearning.AM.ApplicationMaster();
      appMaster.init();
      if (appMaster.run()) {
