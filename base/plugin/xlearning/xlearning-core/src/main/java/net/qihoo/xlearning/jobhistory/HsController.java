...
import net.qihoo.xlearning.jobhistory.HsJobPage;
import net.qihoo.xlearning.jobhistory.HsLogsPage;
...
public class HsController extends Controller implements AMParams {
  ...
  private static final Log LOG = LogFactory.getLog(net.qihoo.xlearning.jobhistory.HsController.class);
