...
public class ApplicationMessageService extends AbstractService implements
  ...
  private static final Log LOG = LogFactory.getLog(net.qihoo.xlearning.AM.ApplicationMessageService.class);
  ...
  public ApplicationMessageService(ApplicationContext applicationContext, Configuration conf) {
    super(net.qihoo.xlearning.AM.ApplicationMessageService.class.getSimpleName());
    this.setConfig(conf);
