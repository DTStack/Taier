...
import net.qihoo.xlearning.jobhistory.HeaderBlock;
import net.qihoo.xlearning.jobhistory.HsJobBlock;
import net.qihoo.xlearning.jobhistory.HsSingleJobBlock;
