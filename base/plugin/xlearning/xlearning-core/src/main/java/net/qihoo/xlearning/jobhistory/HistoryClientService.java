...
import net.qihoo.xlearning.jobhistory.HsWebApp;
...
public class HistoryClientService extends AbstractService {
  ...
  private static final Log LOG = LogFactory.getLog(net.qihoo.xlearning.jobhistory.HistoryClientService.class);
  ...
  protected void initializeWebApp(Configuration conf) {
    ...
    try {
      ...
      WebApps
          .$for("jobhistory", net.qihoo.xlearning.jobhistory.HistoryClientService.class, this, "ws")
          .with(conf)
