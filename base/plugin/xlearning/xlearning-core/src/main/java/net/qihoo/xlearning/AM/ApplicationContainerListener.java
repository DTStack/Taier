...
import net.qihoo.xlearning.api.ContainerListener;
...
public class ApplicationContainerListener extends AbstractService implements ApplicationContainerProtocol,
  ...
  private static final Log LOG = LogFactory.getLog(net.qihoo.xlearning.AM.ApplicationContainerListener.class);
  ...
  public ApplicationContainerListener(ApplicationContext applicationContext, Configuration conf) {
    super(net.qihoo.xlearning.AM.ApplicationContainerListener.class.getSimpleName());
    this.setConfig(conf);
