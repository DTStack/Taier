...
public class Client {
  ...
  private static final Log LOG = LogFactory.getLog(net.qihoo.xlearning.client.Client.class);
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      net.qihoo.xlearning.client.Client client = new net.qihoo.xlearning.client.Client(args);
      client.init();
