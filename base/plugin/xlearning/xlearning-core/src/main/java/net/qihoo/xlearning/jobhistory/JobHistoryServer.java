...
import net.qihoo.xlearning.jobhistory.HistoryClientService;
import net.qihoo.xlearning.jobhistory.XLearningWebAppUtil;
...
public class JobHistoryServer extends CompositeService {
  ...
  private static final Log LOG = LogFactory.getLog(net.qihoo.xlearning.jobhistory.JobHistoryServer.class);
  ...
  public JobHistoryServer() {
    super(net.qihoo.xlearning.jobhistory.JobHistoryServer.class.getName());
  }
  ...
  static net.qihoo.xlearning.jobhistory.JobHistoryServer launchJobHistoryServer(String[] args) {
    Thread.
        setDefaultUncaughtExceptionHandler(new YarnUncaughtExceptionHandler());
    StringUtils.startupShutdownMessage(net.qihoo.xlearning.jobhistory.JobHistoryServer.class, args, LOG);
    net.qihoo.xlearning.jobhistory.JobHistoryServer jobHistoryServer = null;
    try {
      jobHistoryServer = new net.qihoo.xlearning.jobhistory.JobHistoryServer();
