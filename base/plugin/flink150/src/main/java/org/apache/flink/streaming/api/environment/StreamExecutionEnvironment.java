 ...
 *
 * @see LocalStreamEnvironment
 * @see RemoteStreamEnvironment
 */
@Public
public abstract class StreamExecutionEnvironment {
     ...
     *
     * @see #setStreamTimeCharacteristic(TimeCharacteristic)
     *
     ...
     * (using {@link SingleOutputStreamOperator#setParallelism(int)})
     ...
     * {@link #fromCollection(Iterator, Class)} does not supply all type information.
     *
     * <p>Note that this operation will result in a non-parallel data stream source, i.e.,
     ...
     * {@link #fromParallelCollection(SplittableIterator, Class)} does not
     ...
     * unless the input format implements the {@link ResultTypeQueryable} interface.
     * In the latter case, this method will invoke the
     * {@link ResultTypeQueryable#getProducedType()} method to determine data
     ...
     * @param watchType
     * 		The watch type of file stream. When watchType is {@link FileMonitoringFunction.WatchType#ONLY_NEW_FILES}, the system processes
     * 		only
     * 		new files. {@link FileMonitoringFunction.WatchType#REPROCESS_WITH_APPENDED} means that the system re-processes all contents of
     * 		appended file. {@link FileMonitoringFunction.WatchType#PROCESS_ONLY_APPENDED} means that the system processes only appended
     * 		contents
     * 		of files.
    ...
    /**
     * Generic method to create an input data stream with {@link InputFormat}.
     *
     * <p>Since all data streams need specific information about their types, this method needs to determine the
     * type of the data produced by the input format. It will attempt to determine the data type by reflection,
     * unless the input format implements the {@link ResultTypeQueryable} interface.
     ...
     * implement {@link ParallelSourceFunction} or extend {@link
     ...
     * DataStreamSource#setParallelism(int)}
     *
     * @param function
     ...
     * is not disabled in the {@link ExecutionConfig}
     */
    @Internal
