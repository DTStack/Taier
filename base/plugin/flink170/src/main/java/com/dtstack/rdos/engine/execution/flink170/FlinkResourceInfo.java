...
import static com.dtstack.rdos.engine.execution.flink170.constrant.ConfigConstrant.*;
...
public class FlinkResourceInfo extends EngineResourceInfo {
    ...
    public FlinkResourceInfo getFlinkSessionSlots(String message, int flinkSessionSlotCount){
