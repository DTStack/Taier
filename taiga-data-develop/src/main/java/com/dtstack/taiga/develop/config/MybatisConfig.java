...
@ComponentScan(basePackages = {"com.dtstack.taiga.*"})
@MapperScan(basePackages = {"com.dtstack.taiga.dao.mapper","com.dtstack.taiga.develop.dao"}, sqlSessionTemplateRef = "sqlSessionTemplate")
public class MybatisConfig {
    ...
    public SqlSessionFactory sqlSessionFactory() throws Exception {
        ...
        sqlSessionFactoryBean.setTypeAliasesPackage("com.dtstack.taiga.dao.domain,com.dtstack.taiga.develop.domain");
