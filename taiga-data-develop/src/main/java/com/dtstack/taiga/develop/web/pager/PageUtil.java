...
import com.dtstack.taiga.common.param.DtInsightPageAuthParam;
...
public class PageUtil {
     ...
     * @return 视图层page
     */
    public static <V> com.dtstack.taiga.common.pager.PageResult<List<V>> transfer(List<V> dataList, DtInsightPageAuthParam param, int total) {
        ...
        return new com.dtstack.taiga.common.pager.PageResult<>(currentPage, pageSize, total, totalPage, dataList);
    }
