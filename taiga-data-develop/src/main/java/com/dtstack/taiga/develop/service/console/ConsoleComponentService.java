...
import com.dtstack.taiga.dao.mapper.KerberosMapper;
import com.dtstack.taiga.develop.model.ClusterFactory;
import com.dtstack.taiga.develop.model.Part;
import com.dtstack.taiga.develop.model.PartCluster;
...
import com.dtstack.taiga.scheduler.service.QueueService;
...
public class ConsoleComponentService {
    ...
    public ComponentVO addOrUpdateComponent(Long clusterId, String componentConfig,
        ...
        // 判断是否是更新组件, 需要校验组件版本
        com.dtstack.taiga.dao.domain.Component dbComponent = componentMapper.getByClusterIdAndComponentType(clusterId, componentType.getTypeCode(),
        ...
        if (EComponentType.HDFS == componentType) {
            ...
            com.dtstack.taiga.dao.domain.Component yarnComponent = componentMapper.getByClusterIdAndComponentType(clusterId, EComponentType.YARN.getTypeCode(), null, null);
