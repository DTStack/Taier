...
VALUES
  ...
  ('10', 'CARBON_SQL', '12', 'CarbonSQL', 'CarbonSQL', '12', now(), now(), '0'),
  ('10', 'KYLIN_CUBE', '16', 'Cube(Kylin)', 'Cube(Kylin)', '16', now(), now(), '1'),
  ...
  ('12', 'LIBRA_SQL', '15', 'LibraSQL', 'LibraSQL', '1', now(), now(), '0'),
  ('12', 'VIRTUAL', '-1', '虚节点', 'Virtual', '2', now(), now(), '0'),
  ('12', 'WORK_FLOW', '10', '工作流', 'WORKFLOW', '3', now(), now(), '0'),
  ('6', 'LibraSQLFunction', '4', 'LibraSQL', 'LibraSQLFunction', '6', now(), now(), '0'),
  ('6', 'SparkSQLFunction', '4', 'SparkSQL', 'SparkSQLFunction', '4', now(), now(), '0'),
  ('6', 'TiDBSQLFunction', '4', 'TiDB SQL', 'TiDBSQLFunction', '5', now(), now(), '0'),
  ('6', 'OracleSQLFunction', '4', 'Oracle SQL', 'OracleSQLFunction', '5', now(), now(), '0'),
