package com.dtstack.engine.dtscript.execution.sparkyarn.restart;
 ...
 */
public class SparkUndoRestart implements IJobRestartStrategy {

    private static Logger logger = LoggerFactory.getLogger(SparkUndoRestart.class);
