...
@ApiModel("任务详情信息")
public class DevelopJobFindTaskRuleJobResultVO {
    ...
    private List<DevelopJobFindTaskRuleJobResultVO> scheduleDetailsVOList;
    ...
    public List<DevelopJobFindTaskRuleJobResultVO> getScheduleDetailsVOList() {
        return scheduleDetailsVOList;
    }

    public void setScheduleDetailsVOList(List<DevelopJobFindTaskRuleJobResultVO> scheduleDetailsVOList) {
