...
/**
 * @Author: toutiann
 * @Date: 2023/03/09/9:00 PM
 */
@Component
public class HadoopTaskSaver extends AbstractTaskSaver {
    ...
    public static Logger LOGGER = LoggerFactory.getLogger(HadoopTaskSaver.class);
    ...
    public List<EScheduleJobType> support() {
        return Lists.newArrayList(EScheduleJobType.HADOOP_MR);
    }
