...
@Mapper
public interface DevelopCatalogueMapstructTransfer {
    DevelopCatalogueMapstructTransfer INSTANCE = Mappers.getMapper(DevelopCatalogueMapstructTransfer.class);
     ...
     * @return
     */
    DevelopCatalogue newCatalogueAddVoToCatalogueVo(DevelopCatalogueAddVO vo);
     ...
     * @return
     */
    DevelopCatalogueVO newCatalogueUpdateVoToCatalogueVo(DevelopCatalogueUpdateVO vo);
     ...
     * @return
     */
    DevelopCatalogueResultVO newCatalogueVoToCatalogueResultVo(CatalogueVO vo);
}
