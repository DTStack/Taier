...
import com.dtstack.taier.develop.service.template.kafka.Kafka11Reader;
 ...
 */
@Component
public class Kafka11ReaderBuilder extends KafkaBaseReaderBuilder {
    @Override
    public KafkaBaseReader createKafkaReader(Map<String, Object> sourceMap) {
        return new Kafka11Reader();
    }
