...
public class BatchFunctionQueryResultVO {
    ...
    public BatchFunctionUserVO getCreateUser() {
        return createUser;
    }

    public void setCreateUser(BatchFunctionUserVO createUser) {
        this.createUser = createUser;
    }

    public BatchFunctionUserVO getModifyUser() {
        return modifyUser;
    }

    public void setModifyUser(BatchFunctionUserVO modifyUser) {
