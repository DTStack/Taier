...
@ApiModel("函数结果信息")
public class DevelopFunctionAddResultVO {
    ...
    private List<DevelopFunctionCatalogueVO> catalogues;

    @ApiModelProperty(value = "依赖任务信息")
    private List<DevelopFunctionTaskVO> tasks;

    @ApiModelProperty(value = "任务类型", example = "1")
    private Integer taskType;

    @ApiModelProperty(value = "依赖任务信息")
    private List<DevelopFunctionTaskVO> dependencyTasks;
    ...
    public List<DevelopFunctionCatalogueVO> getCatalogues() {
        return catalogues;
    }

    public void setCatalogues(List<DevelopFunctionCatalogueVO> catalogues) {
        this.catalogues = catalogues;
    }

    public List<DevelopFunctionTaskVO> getTasks() {
        return tasks;
    }

    public void setTasks(List<DevelopFunctionTaskVO> tasks) {
        this.tasks = tasks;
    }
    ...
    public List<DevelopFunctionTaskVO> getDependencyTasks() {
        return dependencyTasks;
    }

    public void setDependencyTasks(List<DevelopFunctionTaskVO> dependencyTasks) {
