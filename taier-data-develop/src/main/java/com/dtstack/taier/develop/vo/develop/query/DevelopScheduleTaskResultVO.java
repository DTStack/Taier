...
@ApiModel("调度任务信息")
public class DevelopScheduleTaskResultVO {
    ...
    @ApiModelProperty(value = "任务信息")
    private List<DevelopScheduleTaskResultVO> taskVOS;
    ...
    private List<DevelopScheduleTaskResultVO> taskRuleList;
    ...
    public List<DevelopScheduleTaskResultVO> getTaskVOS() {
        return taskVOS;
    }

    public void setTaskVOS(List<DevelopScheduleTaskResultVO> taskVOS) {
    ...
    public List<DevelopScheduleTaskResultVO> getTaskRuleList() {
        return taskRuleList;
    }

    public void setTaskRuleList(List<DevelopScheduleTaskResultVO> taskRuleList) {
