 ...
 * create: 2018/1/4
 */
public class DevelopFunctionVO extends DevelopFunction {

    private static final Logger logger = LoggerFactory.getLogger(DevelopFunction.class);

    public static DevelopFunctionVO toVO(DevelopFunction origin) {
        DevelopFunctionVO vo = new DevelopFunctionVO();
        try {
