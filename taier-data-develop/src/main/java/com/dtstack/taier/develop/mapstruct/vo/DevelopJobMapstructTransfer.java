...
@Mapper
public interface DevelopJobMapstructTransfer {
    DevelopJobMapstructTransfer INSTANCE = Mappers.getMapper(DevelopJobMapstructTransfer.class);


    /**
     * ExecuteResultVO --> DevelopExecuteResultVO
     *
