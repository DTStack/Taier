 ...
 */
public class DevelopTaskDevelopVO extends ScheduleTaskVO {

    private static final Logger LOG = LoggerFactory.getLogger(DevelopTaskDevelopVO.class);

    public DevelopTaskDevelopVO(ScheduleTaskVO task) {
