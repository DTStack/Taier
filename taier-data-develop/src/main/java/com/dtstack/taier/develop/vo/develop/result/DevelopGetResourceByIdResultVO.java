...
@ApiModel("获取资源返回信息")
public class DevelopGetResourceByIdResultVO {

    @ApiModelProperty(value = "创建用户")
    private DevelopUserBaseResultVO createUser;

    @ApiModelProperty(value = "修改用户")
    private DevelopUserBaseResultVO modifyUser;

    @ApiModelProperty(value = "资源路径", example = "hdfs://ns1/rdos/Develop/***")
    private String url;
    ...
    public DevelopUserBaseResultVO getCreateUser() {
        return createUser;
    }

    public void setCreateUser(DevelopUserBaseResultVO createUser) {
        this.createUser = createUser;
    }

    public DevelopUserBaseResultVO getModifyUser() {
        return modifyUser;
    }

    public void setModifyUser(DevelopUserBaseResultVO modifyUser) {
