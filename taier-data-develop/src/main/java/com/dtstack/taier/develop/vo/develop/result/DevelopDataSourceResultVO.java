...
@ApiModel("数据源结果信息")
public class DevelopDataSourceResultVO {
    ...
    private DevelopDataSourceUserVO modifyUser;
    ...
    public DevelopDataSourceUserVO getModifyUser() {
        return modifyUser;
    }

    public void setModifyUser(DevelopDataSourceUserVO modifyUser) {
