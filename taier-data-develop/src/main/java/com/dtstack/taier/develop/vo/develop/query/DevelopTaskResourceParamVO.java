...
@ApiModel("任务信息")
public class DevelopTaskResourceParamVO extends DtInsightAuthParam {
    ...
    private List<DevelopTaskResourceParamVO> toUpdateTasks;
    ...
    public List<DevelopTaskResourceParamVO> getToUpdateTasks() {
        return toUpdateTasks;
    }

    public void setToUpdateTasks(List<DevelopTaskResourceParamVO> toUpdateTasks) {
