...
public class RequestResponseBodyMethodProcessor extends AbstractMessageConverterMethodProcessor {
	...
	private void setBaseInfo(Object arg, HttpServletRequest servletRequest, String filedName, String infoName, Function<HttpServletRequest,String> callBack) {
		try {
			if (!arg.getClass().isArray()) {
				setField(arg, servletRequest, filedName, infoName, callBack);
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	private void setField(Object arg, HttpServletRequest servletRequest, String filedName, String infoName, Function<HttpServletRequest, String> callBack) throws IllegalAccessException {
		Field field = ReflectionUtils.findField(arg.getClass(), filedName);
		if (field != null) {
