 ...
 *						ElasticsearchOutputFunction<Tuple2<Integer, String>> {
 *
 ...
 * }</pre>
 *
 * @param <T> The type of the element handled by this {@code ElasticsearchOutputFunction}
 */
public interface ElasticsearchOutputFunction<T> extends Serializable, Function {
