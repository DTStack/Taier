...
public class SparkClient extends AbsClient {
    ...
    /**默认driver可以使用的内存大小*/
    private static final String DEFAULT_DRIVER_MEM = "512m";
    ...
    private static final String DEFAULT_EXECUTOR_HEARTBEARTINTERVAL = "600s";

    //spark 所有网络传输的超时时间
    private static final String DEFAULT_NETWORK_TIMEOUT = "600s";
