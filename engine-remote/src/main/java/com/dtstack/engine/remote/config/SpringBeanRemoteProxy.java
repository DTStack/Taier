 ...
 */
public class SpringBeanRemoteProxy<T> extends RemoteProxy<T> implements ApplicationContextAware {
    private static final Logger LOGGER = LoggerFactory.getLogger(SpringBeanRemoteProxy.class);

    private ApplicationContext applicationContext;

    protected SpringBeanRemoteProxy(Class<T> interfaceClass) {
    ...
    protected Object proxyRun(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        try {
            ...
            LOGGER.error("an error occurred:e:{}, perform fusing :{}",e.toString(),e);
    ...
    private Message buildMessage(Method method, Object[] args) {
        ...
        message.setIdentifier(annotation.value());
