...
import com.dtstack.engine.base.filesystem.manager.LocalFileManage;
 ...
 * @author maqi
 */
public class LocalFileManageFactory implements IFileManageFactory<FileConfig>{
    @Override
    public IFileManage createFileManage(FileConfig config) {
        return new LocalFileManage();
    }
}
