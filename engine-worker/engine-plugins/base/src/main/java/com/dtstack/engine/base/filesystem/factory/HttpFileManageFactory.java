...
import com.dtstack.engine.base.filesystem.manager.HttpFileManage;
 ...
 * @author maqi
 */
public class HttpFileManageFactory implements IFileManageFactory<FileConfig> {
    @Override
    public IFileManage createFileManage(FileConfig config) {
        return new HttpFileManage();
    }
}
