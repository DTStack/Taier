...
public class FlinkUtil {
    ...
    public static PackagedProgram buildProgram(String jarFilePath, List<URL> classpaths, EJobType jobType,
                                               String entryPointClass, String[] programArgs,
                                               SavepointRestoreSettings spSetting, org.apache.flink.configuration.Configuration flinkConfiguration)
