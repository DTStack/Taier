...
public class FlinkClient extends AbstractClient {
                ...
                try {
                    ...
                    if (rdosTaskStatus != null && !RdosTaskStatus.getStoppedStatus().contains(rdosTaskStatus.getStatus())) {
                        ...
                        if (StringUtils.isEmpty(appId)) {
                            ...
                            logger.info("taskId: {}, flink job savepoint path {}", jobIdentifier.getTaskId(), ask.toString());
                        }
                    }
    ...
    public String getJobLog(JobIdentifier jobIdentifier) {
        ...
        try {
            ...
            logger.error("taskId: {} , get job log error: ", jobIdentifier.getTaskId(), e);
    ...
    public String getCheckpoints(JobIdentifier jobIdentifier) {
        ...
        try {
            ...
            logger.error("taskId: {}, taskStatus is {}, Get checkpoint error: ", jobIdentifier.getTaskId(), taskStatus.name(), e);
        }
        return checkpointMsg;
    }
