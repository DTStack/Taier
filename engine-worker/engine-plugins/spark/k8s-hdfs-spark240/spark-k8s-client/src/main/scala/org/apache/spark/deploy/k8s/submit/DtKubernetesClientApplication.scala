...
/**
  ...
  *
  */
private[spark] class DtKubernetesClientApplication extends SparkApplication {
  ...
  def run(clientArguments: ClientArguments, sparkConf: SparkConf): String = {
    ...
    val kubernetesResourceNamePrefix = DtKubernetesClientApplication.getResourceNamePrefix(appName)
    // pyFile
...
private[spark] object DtKubernetesClientApplication {
