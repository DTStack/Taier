...
public class ClientOperator {
    ...
    public List<Column> getAllColumns(String tableName, String schemaName, String dbName, String pluginInfo,String engineType) throws ClientAccessException {
        if(null == clientCache || null == engineType){
            return null;
        }
        IClient client = clientCache.getClient(engineType, pluginInfo);
        return client.getAllColumns(tableName,schemaName,dbName);
    }
