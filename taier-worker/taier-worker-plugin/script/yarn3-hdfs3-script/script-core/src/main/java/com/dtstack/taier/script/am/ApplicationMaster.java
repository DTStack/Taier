...
public class ApplicationMaster extends CompositeService {
    ...
    private boolean run() throws IOException, NoSuchAlgorithmException, InterruptedException {
        ...
        List<Container> acquiredWorkerContainers = handleRmCallbackOfContainerRequest(
                dtconf.getInt(ScriptConfiguration.SCRIPT_WORKER_NUM, ScriptConfiguration.DEFAULT_SCRIPT_WORKER_NUM), workerContainerRequest, interval);
