...
public class HighAvailabilityServicesUtils {
    ...
    public static ClientHighAvailabilityServices createClientHAService(Configuration configuration)
        ...
        switch (highAvailabilityMode) {
            ...
            case ZOOKEEPER:
                ...
                boolean appendJaasEnable = configuration.getBoolean(ConfigConstant.ZOOKEEPER_CLIENT_APPEND_JAAS_ENABLE, false);
                if (appendJaasEnable) {
    ...
    public static String getWebMonitorAddress(
            Configuration configuration, AddressResolution resolution)
