...
import com.dtstack.taiga.scheduler.enums.RestartType;
import com.dtstack.taiga.scheduler.server.action.restart.impl.RestartCurrentAndDownStreamNodeRestartJob;
import com.dtstack.taiga.scheduler.server.action.restart.impl.RestartCurrentNodeRestartJob;
import com.dtstack.taiga.scheduler.server.action.restart.impl.SetSuccessAndResumeSchedulingRestartJob;
