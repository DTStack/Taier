...
public class BatchTaskShadeDTO extends BatchTaskShade {
    ...
    public PageQuery<BatchTaskShadeDTO> getPageQuery() {
        PageQuery<BatchTaskShadeDTO> query = new PageQuery<>(this.getPageIndex(), this.getPageSize(), "gmt_modified", this.getSort());
        query.setModel(this);
        return query;
    }
}
