...
public class CommonUtils {
     ...
     * @return
     */
    public static <T> String collectionJoinCsv(Collection<T> collection, String join) {
        Objects.requireNonNull(join);
        if (Collects.isEmpty(collection)) {
            return "";
        }
     ...
     * @return
     */
    public static <T> String collectionJoinForNum(Collection<T> collection, String join) {
        Objects.requireNonNull(join);
        if (Collects.isEmpty(collection)) {
            return "";
        }
     ...
     * @return
     */
    public static String plusSingleQuotes(String strValue, Boolean isArr, Boolean isNumber) {
        ...
        if (isArr) {
            ...
            if (isNumber) {
                return collectionJoinForNum(Arrays.asList(split), ",");
            } else {
                return collectionJoin(Arrays.asList(split), ",");
            }
        } else {
            if (isNumber) {
                return strValue;
    ...
    public static <T> List<T> addElementInCircle(List<T> list, T object) {
