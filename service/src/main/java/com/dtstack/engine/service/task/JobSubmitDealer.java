...
public class JobSubmitDealer implements Runnable {
    ...
    public JobSubmitDealer(String jobResource, String engineType, String groupName, GroupPriorityQueue priorityQueue) {
        ...
        ExecutorService executorService = new ThreadPoolExecutor(1, 1, 0L, TimeUnit.MILLISECONDS,
                new LinkedBlockingQueue<>(), new CustomThreadFactory(this.getClass().getSimpleName() + "_DelayJobProcessor"));
    ...
    private void handlerNoResource(JobClient jobClient) {
        ...
        boolean isPutLackingJob = (priorityQueue.getQueue().size() > (priorityQueue.getQueueSizeLimited() >> 2)) || jobClient.isLackLimited();
        if (isPutLackingJob) {
