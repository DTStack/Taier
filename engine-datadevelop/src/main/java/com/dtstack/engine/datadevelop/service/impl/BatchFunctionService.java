...
public class BatchFunctionService {
    ...
    private static final Logger logger = LoggerFactory.getLogger(com.dtstack.batch.service.impl.BatchFunctionService.class);
    ...
    @Autowired
    private com.dtstack.batch.service.impl.BatchResourceService batchResourceService;
