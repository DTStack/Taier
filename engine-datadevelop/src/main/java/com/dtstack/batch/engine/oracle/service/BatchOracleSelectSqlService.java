 ...
 */
@Service
public class BatchOracleSelectSqlService implements IBatchSelectSqlService {
    @Override
    ...
    @Override
    public ExecuteResultVO selectData(BatchTask task, BatchHiveSelectSql selectSql, Long tenantId, Long projectId, Long dtuicTenantId, Long userId, Boolean isRoot, Integer taskType) throws Exception {
