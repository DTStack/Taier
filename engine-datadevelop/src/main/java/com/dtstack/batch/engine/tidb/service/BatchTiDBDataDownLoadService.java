...
import com.dtstack.batch.engine.rdbms.common.TiDBDownloadBuilder;
 ...
 */
@Service
public class BatchTiDBDataDownLoadService implements IDataDownloadService {
    ...
    private TiDBDownloadBuilder builder = new TiDBDownloadBuilder();
    ...
    public IDownload downloadSqlExeResult(String jobId, Long tenantId, Long projectId, Long dtuicTenantId, boolean needMask) {
        ...
        if (Objects.isNull(projectDb)){
            throw new RdosDefineException("当前项目未对接TIDB引擎");
        }
        return TiDBDownloadBuilder.createDownLoadDealer(batchHiveSelectSql.getSqlText(), dtuicTenantId, projectDb.getEngineIdentity());
    }
    ...
    public List<Object> queryDataFromTable(Long dtuicTenantId, Long projectId, String tableName, String db, Integer num, List<String> fieldNameList, Boolean permissionStyle, boolean needMask) throws Exception {
        ...
        List<List<Object>> queryResult = jdbcServiceImpl.executeQuery(dtuicTenantId,null, EJobType.TIDB_SQL, db, sql);
