...
/**
 * @author chener
 * @Classname BatchGreenplumSelectSqlService
 * @Description TODO
 * @Date 2020/5/19 21:54
 * @Created chener@dtstack.com
 */
@Service
public class BatchGreenplumSelectSqlService implements IBatchSelectSqlService {
    @Override
    ...
    @Override
    public ExecuteResultVO selectData(BatchTask batchTask, BatchHiveSelectSql selectSql, Long tenantId, Long projectId, Long dtuicTenantId, Long userId, Boolean isRoot, Integer taskType) {
