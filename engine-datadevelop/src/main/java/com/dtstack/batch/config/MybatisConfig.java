...
@MapperScan(basePackages = {"com.dtstack.engine.dao","com.dtstack.engine.datasource.dao.mapper","com.dtstack.batch.dao"}, sqlSessionTemplateRef = "sqlSessionTemplate")
