...
@Data
@ApiModel("获取补数据详情信息")
public class BatchJobGetFillDataDetailInfoVO extends DtInsightAuthParam {


    @ApiModelProperty(value = "任务实例ID列表", required = true)
    private List<String> flowJobIdList;

    @ApiModelProperty(value = "补数据名称",example = "P_dev2_HADOOP2hive_sdsadasd_2020_12_30_31_35", required = true)
    private String fillJobName;

    @ApiModelProperty(value = "责任人ID", example = "2", required = true)
    private Long dutyUserId;

    @ApiModelProperty(value = "搜索类型",example = "fuzzy", required = true)
    ...
    @ApiModelProperty(value = "exec时间排序", example = "desc")
    private String execTimeSort;

    @ApiModelProperty(value = "exec开始时间排序", example = "desc")
    private String execStartSort;

    @ApiModelProperty(value = "exec结束时间排序", example = "desc")
