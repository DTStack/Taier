...
@Data
@ApiModel("查询任务实例信息")
public class BatchJobQueryJobVO extends DtInsightAuthParam {
    ...
    @ApiModelProperty(value = "任务实例Id", example = "123")
    ...
    @ApiModelProperty(value = "搜索类型",example = "fuzzy")
    ...
    @ApiModelProperty(value = "负责ID", example = "1L", required = true)
