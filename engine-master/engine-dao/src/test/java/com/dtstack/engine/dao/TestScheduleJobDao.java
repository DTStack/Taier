...
public interface TestScheduleJobDao {
    @Insert({ "INSERT INTO schedule_job\n" +
            ...
            "    status, task_type, max_retry_num, node_address, version_id, source_type, compute_type, exec_start_time, exec_end_time)\n" +
            "   VALUES\n" +
            ...
            "   #{scheduleJob.status}, #{scheduleJob.taskType}, #{scheduleJob.maxRetryNum}, #{scheduleJob.nodeAddress}, #{scheduleJob.versionId}, #{scheduleJob.sourceType}, #{scheduleJob.computeType}, #{scheduleJob.execStartTime}, #{scheduleJob.execEndTime})" })
