...
public enum SourceType2TableType {
    HIVE(ETableType.HIVE, Sets.newHashSet(DataSourceType.HIVE1X,DataSourceType.HIVE,DataSourceType.Spark,DataSourceType.SPARKTHRIFT2_1,DataSourceType.INCEPTOR_SQL)),
