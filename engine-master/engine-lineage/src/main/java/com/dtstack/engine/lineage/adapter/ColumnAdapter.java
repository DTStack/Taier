...
public class ColumnAdapter {
    public static com.dtstack.engine.common.pojo.Column sqlColumn2ApiColumn(Column sqlColumn){
        com.dtstack.engine.common.pojo.Column column = new com.dtstack.engine.common.pojo.Column();
    ...
    public static Column apiColumn2SqlColumn(com.dtstack.engine.common.pojo.Column apiColumn){
