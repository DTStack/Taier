...
public interface TestScheduleJobDao {
    @Insert({ "INSERT INTO schedule_job\n" +
            ...
            "    status, task_type, max_retry_num, node_address, version_id, compute_type, exec_start_time, exec_end_time, log_info, engine_log)\n" +
            "   VALUES\n" +
            ...
            "   #{scheduleJob.status}, #{scheduleJob.taskType}, #{scheduleJob.maxRetryNum}, #{scheduleJob.nodeAddress}, #{scheduleJob.versionId}, #{scheduleJob.computeType}, #{scheduleJob.execStartTime}, #{scheduleJob.execEndTime}, #{scheduleJob.logInfo}, #{scheduleJob.engineLog})" })
