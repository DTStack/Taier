...
public interface TestScheduleJobDao {
    @Insert({ "Replace INTO schedule_job\n" +
            ...
            "   #{scheduleJob.status}, #{scheduleJob.taskType}, #{scheduleJob.maxRetryNum}, #{scheduleJob.nodeAddress}, #{scheduleJob.versionId}, #{scheduleJob.sourceType}, #{scheduleJob.computeType}, #{scheduleJob.applicationId}, #{scheduleJob.execStartTime}, #{scheduleJob.execEndTime}, #{scheduleJob.logInfo}, #{scheduleJob.engineLog})" })
