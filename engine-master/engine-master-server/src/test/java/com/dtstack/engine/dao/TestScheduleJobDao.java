...
public interface TestScheduleJobDao {
    @Insert({ "INSERT INTO schedule_job\n" +
            ...
            "    status, task_type, max_retry_num, node_address, version_id, compute_type, application_id, exec_start_time, exec_end_time, exec_time,log_info, engine_log,engine_job_id,component_version)\n" +
            "   VALUES\n" +
            ...
            "   #{scheduleJob.status}, #{scheduleJob.taskType}, #{scheduleJob.maxRetryNum}, #{scheduleJob.nodeAddress}, #{scheduleJob.versionId}, #{scheduleJob.computeType}, #{scheduleJob.applicationId}, #{scheduleJob.execStartTime}, #{scheduleJob.execEndTime}, #{scheduleJob.execTime}, #{scheduleJob.logInfo}, #{scheduleJob.engineLog},#{scheduleJob.engineJobId},#{scheduleJob.componentVersion})" })
    ...
    @Insert({ "INSERT INTO schedule_job\n" +
            "    (gmt_create, gmt_modified, tenant_id, project_id, dtuic_tenant_id, app_type, job_id, job_key, job_name, task_id,\n" +
            "    create_user_id, is_deleted, `type`, is_restart, business_date, cyc_time, dependency_type, flow_job_id,\n" +
            "    status, task_type, max_retry_num, node_address, version_id, compute_type, application_id, exec_start_time, exec_end_time, exec_time,log_info, engine_log,component_version)\n" +
            "   VALUES\n" +
            ...
            "   #{scheduleJob.createUserId}, #{scheduleJob.isDeleted}, #{scheduleJob.type}, #{scheduleJob.isRestart}, #{scheduleJob.businessDate}, #{scheduleJob.cycTime}, #{scheduleJob.dependencyType}, #{scheduleJob.flowJobId},\n" +
            "   #{scheduleJob.status}, #{scheduleJob.taskType}, #{scheduleJob.maxRetryNum}, #{scheduleJob.nodeAddress}, #{scheduleJob.versionId}, #{scheduleJob.computeType}, #{scheduleJob.applicationId}, #{scheduleJob.execStartTime}, #{scheduleJob.execEndTime}, #{scheduleJob.execTime}, #{scheduleJob.logInfo}, #{scheduleJob.engineLog},#{scheduleJob.componentVersion})" })
    @Options(useGeneratedKeys=true, keyProperty = "scheduleJob.id", keyColumn = "id")
