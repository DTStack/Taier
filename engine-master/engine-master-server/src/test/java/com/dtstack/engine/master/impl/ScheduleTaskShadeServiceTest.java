...
public class ScheduleTaskShadeServiceTest extends AbstractTest {
    ...
    public void testTaskShade() {
        ...
        Assert.assertTrue(CollectionUtils.isEmpty(scheduleTaskShadeService.listDependencyTask(taskIds, scheduleTaskShadeDTO.getAppType(), updateTaskName, scheduleTaskShadeDTO.getProjectId())));
        ...
        scheduleTaskShadeService.frozenTask(taskIds, EProjectScheduleStatus.PAUSE.getStatus(), scheduleTaskShadeDTO.getProjectId(), 0L, scheduleTaskShade.getAppType());
