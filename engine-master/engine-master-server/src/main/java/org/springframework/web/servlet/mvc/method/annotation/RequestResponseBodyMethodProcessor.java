...
public class RequestResponseBodyMethodProcessor extends AbstractMessageConverterMethodProcessor {
    ...
    protected <T> Object readWithMessageConverters(NativeWebRequest webRequest, MethodParameter parameter,
        ...
        if (null != arg) {
            setBaseInfo(arg, servletRequest, CookieUtil.PROJECT_FILED, CookieUtil.PROJECT_FILED, (request) -> request.getHeader(CookieUtil.X_PROJECT_ID));
    ...
    private void setBaseInfo(Object arg, HttpServletRequest servletRequest, String filedName, String infoName, Function<HttpServletRequest,String> callBack) {
        try {
            Field filed = arg.getClass().getDeclaredField(filedName);
            filed.setAccessible(true);
            if (filed.get(arg) != null) {
                return;
            }
            ...
            ReflectionUtils.setField(filed, arg, Long.parseLong(infoValue));
        } catch (Exception e) {
        }
    }
