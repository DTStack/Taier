    ...
    public void run() {
        while (RUNNING.get()) {
            ...
            try {
                ...
                logger.info("jobId:{} scheduleType:{} take job from queue，after queueSize:{}, full:{} ",
                        scheduleJob.getJobId(), getScheduleType(), jopPriorityQueue.getQueueSize(), jopPriorityQueue.getFullSize());
