...
public enum TableOperateEnum {
    ...
    ALTERTABLE_MODIFYCOLS("altertable_modifycols", "Modify Column", 55),
    ALTERTABLE_CHANGECOLS("altertable_changecols", "Change Column", 56),
    ALTERTABLE_DROPCOLS("altertable_dropcols", "Drop Column", 57),
