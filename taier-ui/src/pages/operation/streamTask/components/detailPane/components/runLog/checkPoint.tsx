...
class CheckPoint extends React.Component<IProps, IState> {
    ...
    getList(data?: IStreamJobProps | undefined) {
        ...
        const startTime = moment(
            day.format('YYYY MM DD') + ' ' + beginTime.format('HH:mm:ss'),
            'YYYY MM DD HH:mm:ss'
        ).valueOf();
        const handleEndTime = moment(
            day.format('YYYY MM DD') + ' ' + endTime.format('HH:mm:ss'),
            'YYYY MM DD HH:mm:ss'
        ).valueOf();
                ...
                render: (path: string) => (
                    <>
                        ...
                        <CopyToClipboard key="jobIdCopy" text={path} onCopy={copyOk}>
                            <SvgIcon linkHref="iconicon_copy" style={copyIconStyle} />
                        </CopyToClipboard>
                    </>
                ),
            },
