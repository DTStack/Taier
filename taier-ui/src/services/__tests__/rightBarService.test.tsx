...
describe('Test RightBarService', () => {
    ...
    it('Should have correct component', () => {
        ...
        expect(render(rightBarService.createContent(RightBarKind.ENV_PARAMS)!).asFragment()).toMatchSnapshot();
        expect(render(rightBarService.createContent(RightBarKind.TASK_CONFIG)!).asFragment()).toMatchSnapshot();
