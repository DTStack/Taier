...
describe('Test GraphTimePicker Component', () => {
    ...
    it('Should disabled the day after today and time', () => {
        ...
        const hours = Array.from(
            document.querySelectorAll('ul.ant-picker-time-panel-column')[0]?.querySelectorAll('li') || []
        );
        ...
        const minutes = Array.from(
            document.querySelectorAll('ul.ant-picker-time-panel-column')[1]?.querySelectorAll('li') || []
        );
        expect(
        ...
        const seconds = Array.from(
            document.querySelectorAll('ul.ant-picker-time-panel-column')[2]?.querySelectorAll('li') || []
        );
        expect(
    ...
    it('Should support to change value via button', () => {
        const fn = jest.fn();
        const { container } = render(
            <GraphTimePicker timeRange="10m" value={moment(new Date('2022-01-21T12:33:37.000'))} onChange={fn} />
        );
