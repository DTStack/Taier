...
export default (props: { collectionData: any; }) => {
    ...
    return (<React.Fragment>
        ...
        <FormItem
            ...
            name='maxFileSize'
            rules={[{
                required: false, message: '请输入文件大小'
            }, {
            ...
            extra={<div>若要按时间大小进行写入，可修改【环境参数】中 <span className="mtk12">flink.checkpoint.interval</span> 参数</div>}
        >
            <FormInputNumber />
        </FormItem>
        <FormItem
            ...
            name="writeMode"
            rules={[{ required: true }]}
            extra={writeMode == 'replace' && <p style={{ color: 'red' }}>注意：切换为覆盖模式，任务启动时，将删除目标表和历史数据</p>}
        >
            <Radio.Group>
