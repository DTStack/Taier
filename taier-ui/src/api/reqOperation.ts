...
export default {
    ...
    GET_TASK_LOG: `${CONSOLE_BASE_URL}/action/queryJobLog`, // 获取任务告警日志-x
    GET_TASK_TYPESX: `${CONSOLE_BASE_URL}/scheduleTaskShade/querySupportJobTypes`, // 获取任务类型-x新
    ...
    PATCH_TASK_DATA: `${CONSOLE_BASE_URL}/fill/fillData`, // 补数据-x
    STOP_JOB: `${CONSOLE_BASE_URL}/scheduleJob/stopJob`, // 停止任务-x
    BATCH_STOP_JOBS: `${CONSOLE_BASE_URL}/action/batchStopJobs`, // 停止任务-x
    ...
    STOP_FILL_DATA_JOBS: `${CONSOLE_BASE_URL}/action/stopFillDataJobs`, // 停止补数据任务-x
