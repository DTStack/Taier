 ...
 * @date 2025/9/19
 */
public class CollectorRegistryHolder {

    private static final CollectorRegistry collectorRegistry = new CollectorRegistry();

    private static final PrometheusMeterRegistry prometheusMeterRegistry = new PrometheusMeterRegistry(
            new PrometheusPropertiesConfigAdapter(), CollectorRegistryHolder.getCollectorRegistry(), Clock.SYSTEM);

    /**
     * get final CollectorRegistry
     */
