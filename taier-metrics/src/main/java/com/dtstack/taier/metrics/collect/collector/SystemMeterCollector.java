 ...
 * @date 2025/9/17
 */
public class SystemMeterCollector extends AbstractCollector {

    @Override
    public void collect(ThreadPoolStats poolStats) {
        System.out.println("system meter collect: " + poolStats);
    }

    @Override
    public String type() {
        return CollectorTypeEnum.OUTPUT.name().toLowerCase();
    }
}
